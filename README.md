...
# app-template-octave
This is a template for a Octave(MatLab)-based brainlife.io/app

As example the App simply does the following:

<ol>
<li>Loads `config.json` for configuration file.</li>
...
### Contributors
Please see github contributor section for contributor list.
